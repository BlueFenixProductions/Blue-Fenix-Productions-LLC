...
| `inspect_coverage` | Read existing coverage artifacts without re-running tests. Pass `source_file` for per-file detail (uncovered lines/branches). |
